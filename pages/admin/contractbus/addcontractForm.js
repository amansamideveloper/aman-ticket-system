...
// components
import { registerContractBuses, refresh } from '../../../actions/contractbusAction'
...
function AddContractBusForm(props) {
    ...
    console.log(props.contractbus)
    if (props.contractbus.success) {
...
export default connect(mapStateToProps, { registerContractBuses, isAdmin, refresh })(AddContractBusForm)